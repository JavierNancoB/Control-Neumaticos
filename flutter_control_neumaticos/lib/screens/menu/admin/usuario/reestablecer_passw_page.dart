              ...
              if (widget.autoGenerada) ...[
                ...
                StandarButton(
                  onPressed: () async {
                    ...
                    if (exito) {
                      showCustomSnackBar(context, 'Contraseña restablecida automáticamente para ${widget.email}');
                    } else {
                      showCustomSnackBar(context, 'Error al restablecer la contraseña automáticamente', isError: true);
                    }
                  },
                ...
                StandarButton(
                  ...
                  onPressed: () async {
                    if (_formKey.currentState?.validate() ?? false) {
                      ...
                      if (exito) {
                        showCustomSnackBar(context, 'Contraseña manualmente cambiada para ${widget.email}');
                        ...
                        showCustomSnackBar(context, 'Error al restablecer la contraseña', isError: true);
                      }
                    }
                  },
                ),
