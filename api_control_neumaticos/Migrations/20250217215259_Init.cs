        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ESTADO = table.Column<int>(type: "int", unicode: false, maxLength: 50, nullable: false),
                    FECHA_ULTIMA_COMPROBACION = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OBSERVACIÓN = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HISTORIAL_MOVIL", x => x.ID);
                    table.ForeignKey(
                        name: "FK_HISTORIAL_MOVIL_MOVIL_ID_MOVIL",
                        column: x => x.ID_MOVIL,
                        principalTable: "MOVIL",
                        principalColumn: "ID_MOVIL");
                    table.ForeignKey(
                        name: "FK_HISTORIAL_MOVIL_USUARIO_ID_USUARIO",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HISTORIAL_MOVIL_ID_MOVIL",
                table: "HISTORIAL_MOVIL",
                column: "ID_MOVIL");

            migrationBuilder.CreateIndex(
                name: "IX_HISTORIAL_MOVIL_ID_USUARIO",
                table: "HISTORIAL_MOVIL",
                column: "ID_USUARIO");
